...
public class EnemyBehavior : Throwable
{
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if (collision.gameObject.GetComponent<Throwable>()!=null)
        {
            ...
            if ((collidedWith.thrown || thrown || collision.gameObject.GetComponent<EnemyBehavior>() != null))
            {
    ...
    protected override PhysicsMaterial2D CheckBounce(GameObject obj)
    {
        ...
        else if ((isBouncing || thrown) && obj.tag != "Enemy" && obj.name != "Tilemap" && !obj.name.Contains("Wall") && !obj.name.Contains("Door"))
        {
